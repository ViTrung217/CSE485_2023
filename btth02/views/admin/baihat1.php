...
<?php include './views/layout/Category_header.php'; ?>
    <main class="container mt-5">
                <div class="row mb-5">
                    <div class="col-sm-4">
                        <img src="./views/image/songs/cayvagio.jpg" class="img-fluid" alt="...">
                    </div>
                        <?php
                            $query = "SELECT * FROM baiviet JOIN tacgia ON baiviet.ma_tgia = tacgia.ma_tgia JOIN theloai ON baiviet.ma_tloai = theloai.ma_tloai WHERE ten_bhat = 'Cây và gió' ";
