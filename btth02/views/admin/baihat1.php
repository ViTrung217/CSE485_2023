    ...
    <main class="container mt-5">
        <div class="row mb-5">
            ...
            <div class="col-sm-8">
                    ...
                    <p class="card-text"><span class="fw-bold">Bài hát: Cây và gió</p>
                    <p class="card-text"><span class="fw-bold">Thể loại: Rock</p>
                    <p class="card-text"><span class="fw-bold">Tóm tắt: Em và anh, hai đứa quen nhau thật tình cờ. Lời hát của anh từ bài hát “Cây và gió” đã làm tâm hồn em xao động. Nhưng sự thật phũ phàng rằng em chưa bao giờ nói cho anh biết những suy nghĩ tận sâu trong tim mình. Bởi vì em nhút nhát, em không dám đối mặt với thực tế khắc nghiệt, hay thực ra em không dám đối diện với chính mình.</p>
                    <p class="card-text"><span class="fw-bold">Tác giả: Tác giả: Phạm Phương Anh</p>
            </div>
        </div>
    </main>
